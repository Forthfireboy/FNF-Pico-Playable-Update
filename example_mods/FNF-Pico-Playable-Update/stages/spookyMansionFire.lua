...
local bfName = '' -- Nombre del personaje que imita a Boyfriend
local gfName = 'firealt' -- Nombre del personaje que imita a Girlfriend
...
local xGF, yGF = 800, getProperty('boyfriend.y') -- Posición del personaje GF
local isPlayerDad, isPlayerBF, isPlayerGF = false, false, true -- Configuración del lado del jugador
local orderDad, orderBF, orderGF = 11, 10, 50 -- Órdenes de capa para cada personaje
